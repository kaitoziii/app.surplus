...
<div class="grid grid-cols-4 gap-3 mb-4">
    ...
    <div class="bg-white rounded-xl border border-gray-100 p-4">
        ...
        <p class="text-xl font-medium text-gray-800">Rp {{ number_format($todayRevenue, 0, ',', '.') }}</p>
    ...
    <div class="bg-white rounded-xl border border-gray-100 p-4">
        ...
        <p class="text-xl font-medium text-gray-800">Rp {{ number_format($weekRevenue, 0, ',', '.') }}</p>
        ...
        <div class="space-y-3 mb-4">
            ...
            <div>
                ...
                <div class="h-1.5 bg-gray-100 rounded-full overflow-hidden">
                    <div class="h-full bg-green-500 rounded-full" style="width:{{ ($approved/$total)*100 }}%"></div>
                </div>
            </div>
            <div>
                <div class="flex justify-between text-xs mb-1">
                ...
                <div class="h-1.5 bg-gray-100 rounded-full overflow-hidden">
                    <div class="h-full bg-amber-400 rounded-full" style="width:{{ ($pendingMerchants/$total)*100 }}%"></div>
                </div>
            </div>
            <div>
                <div class="flex justify-between text-xs mb-1">
                ...
                <div class="h-1.5 bg-gray-100 rounded-full overflow-hidden">
                    <div class="h-full bg-red-400 rounded-full" style="width:{{ ($rejected/$total)*100 }}%"></div>
                </div>
            </div>
        </div>
